...
class FollowArtistController {
    addFollowArtist(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const rowCreated = yield follow_artist_1.followArtistService.addFollowArtist(user_id, artist_id);
    ...
    delFollowArtist(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user_id, artist_id } = req.body;
                const rowDeleted = yield follow_artist_1.followArtistService.delFollowArtist(user_id, artist_id);
                if (rowDeleted.rowCount === 0) {
                    return next(new customError_1.CustomError(400, 'General', 'no result'));
                }
                else
                    res.status(204).json();
            }
