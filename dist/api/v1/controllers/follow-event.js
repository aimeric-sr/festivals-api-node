...
exports.followEventController = void 0;
...
class FollowEventController {
    addFollowEvent(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const rowCreated = yield follow_event_1.followEventService.addFollowEvent(user_id, event_id);
    ...
    delFollowEvent(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { user_id, event_id } = req.body;
                const rowDeleted = yield follow_event_1.followEventService.delFollowEvent(user_id, event_id);
